...
async function showForecast(latlng) {
    ...
    let osmurl = `https://nominatim.openstreetmap.org/reverse?lat=${latlng.lat}&lon=${latlng.lng}8&zoom=15&format=jsonv2`;
    ...
    let markup = `
        ...
        <li>Luftfeuchtigkeit (%): ${details.relative_humidit}</li>
